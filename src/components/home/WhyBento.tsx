      ...
      <div className="max-w-[1200px] mx-auto relative z-[1]">
        ...
        <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 max-md:grid-cols-1">
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                <span className="text-[0.625rem] text-[rgba(255,255,255,0.3)] uppercase tracking-[0.06em]">
                  REF ID
                </span>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                <span className="font-mono text-[0.6875rem] tracking-[0.08em] text-[rgba(255,255,255,0.5)]">
                  {leadPort.port}
                </span>
              ...
              <div className="font-mono text-[0.625rem] text-[rgba(255,255,255,0.25)]">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {[
              ...
              <div
                key={cert.label}
                className="flex flex-col items-center gap-1.5 px-4 py-3 rounded-xl border border-[rgba(255,255,255,0.06)] hover:border-[var(--color-primary)] transition-all duration-300 group cursor-default min-w-[100px]"
              >
        ...
        {testimonials.map((_, i) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all duration-300 ${
              i === idx ? 'bg-[var(--color-primary)] w-5' : 'bg-[rgba(255,255,255,0.15)]'
            }`}
          />
        ))}
      </div>
